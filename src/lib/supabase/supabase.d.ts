...
> = PublicTableNameOrOptions extends { schema: keyof Database }
  ...
  : PublicTableNameOrOptions extends keyof (Database["cc0vote"]["Tables"] &
      Database["cc0vote"]["Views"])
  ? (Database["cc0vote"]["Tables"] &
      Database["cc0vote"]["Views"])[PublicTableNameOrOptions] extends {
      Row: infer R
    }
    ? R
    : never
